      ...
      >
        ...
        {LEVELS.map((l) => (
          <button
            ...
            style={{
              ...
              fontSize: 12,
              borderRadius: 3,
              border: `1px solid ${level === l.id ? "#D4AF37" : "#1F5C3B"}`,
              background: level === l.id ? "#D4AF37" : "transparent",
        ...
        <button
          ...
          style={{
            ...
            fontSize: 12,
            borderRadius: 3,
            border: `1px solid ${view === "music" ? "#D4AF37" : "#1F5C3B"}`,
            background: view === "music" ? "#D4AF37" : "transparent",
